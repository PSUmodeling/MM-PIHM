...
void Decomp(double tsoil, const epconst_struct *epc, const cstate_struct *cs, const nstate_struct *ns, epvar_struct *epv, cflux_struct *cf, nflux_struct *nf, ntemp_struct *nt)
{
