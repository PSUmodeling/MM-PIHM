...
void CSummary(const cstate_struct *cs, const cflux_struct *cf, summary_struct *summary)
{
    ...
    summary->agc = cs->leafc + cs->leafc_storage + cs->leafc_transfer + cs->livestemc + cs->livestemc_storage +
        cs->livestemc_transfer + cs->deadstemc + cs->deadstemc_storage + cs->deadstemc_transfer;
