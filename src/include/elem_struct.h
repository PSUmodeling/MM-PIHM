...
typedef struct phystate_struct
{
    ...
    double          proj_lai;               // live projected leaf area index (m2 m-2)
    ...
    double          plaisun;                // sunlit projected leaf area index (m2 m-2)
    double          plaishade;              // shaded projected leaf area index (m2 m-2)
#endif
#if defined(_CYCLES_)
...
typedef struct daily_struct
{
    ...
    double          avg_soldn;              // daytime average downward solar radiation (W m-2)
} daily_struct;
#endif
...
typedef struct nstate_struct
{
    ...
    double          soil4n;                 // recalcitrant SOM N (humus, slowest) (kgN m-2)
