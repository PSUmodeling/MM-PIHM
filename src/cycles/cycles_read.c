...
//        (double *)malloc(croptbl->number * sizeof(double));
//    croptbl->userClippingStart = (int *)malloc(croptbl->number * sizeof(int));
...
//        ReadKeyword(cmdstr, "NAME", croptbl->cropName[j], 's', filename, lno);
//
//        NextLine(crop_file, cmdstr, &lno);
...
//            &croptbl->userClippingBiomassThresholdUpper[j], 'd', filename, lno);
//
//        NextLine(crop_file, cmdstr, &lno);
//        ReadKeyword(cmdstr, "CLIPPING_BIOMASS_THRESHOLD_LOWER",
//            &croptbl->userClippingBiomassThresholdLower[j], 'd', filename, lno);
//
//        NextLine(crop_file, cmdstr, &lno);
...
//
//        NextLine(crop_file, cmdstr, &lno);
//        ReadKeyword(cmdstr, "C3", &croptbl->userC3orC4[j], 'i', filename, lno);
//
//        NextLine(crop_file, cmdstr, &lno);
...
//
//                NextLine(op_file, cmdstr, &lno);
//                ReadKeyword(cmdstr, "DOY", &tillage->opDay, 'i', filename, lno);
//
//                NextLine(op_file, cmdstr, &lno);
...
//
//                NextLine(op_file, cmdstr, &lno);
//                ReadKeyword(cmdstr, "DOY", &fixfert->opDay, 'i', filename, lno);
//
//                NextLine(op_file, cmdstr, &lno);
...
//                    fixfert->opP_Inorganic + fixfert->opK + fixfert->opS <= 1.0)
//                {
...
//
//                NextLine(op_file, cmdstr, &lno);
//                ReadKeyword(cmdstr, "DOY", &fixirr->opDay, 'i', filename, lno);
//
//                NextLine(op_file, cmdstr, &lno);
...
//                (autoirr_struct *)malloc(nautoirrg * sizeof(autoirr_struct));
//            /* Rewind to the beginning of file and read all planting operations */
//            FindLine(op_file, "BOF", &lno, filename);
//
...
//                    &cropmgmt->autoIrrigation[j].startDay, 'i', filename, lno);
//
//                NextLine(op_file, cmdstr, &lno);
