    ...
    Chem_Data CD, realtype t)
{
    ...
    int             i, j, k, num_face =
        ...
        num_conditions = 0, line_width = LINE_WIDTH, words_line =
        WORDS_LINE, word_width = WORD_WIDTH, Global_diff = 0, Global_disp =
        0, error_flag = 0, speciation_flg = 0, specflg;
    ...
    N_Vector VY)
{
    ...
    double          timelps, rt_step, temp_rt_step, peclet, tmptime, tmpval,
        invavg, unit_c, tmpconc, timer1, timer2;
    realtype       *Y;
    realtype        MF_CONVERT;
