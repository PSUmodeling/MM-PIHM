...
typedef struct vol_conc_type
{
  ...
  realtype temperature;    /* temperature of the block */
...
typedef struct Kinetic_Reaction_structure
{
  ...
  char**   monod;              /* species that this kinetic rate depends on for monod type */
  double*  monod_para;         /* parameters for monod dependency */
  char**   inhibition;         /* species that this kinetic rate is inhibited by, for monod type */
  double*  inhibition_para;    /* parameters that controls this inhibition */
} Kinetic_Reaction;
...
typedef struct Chem_Data_structure
{
  ...
  int *  prepconcindex;  /* index of prep concentration specifieid in .prep file */
  ...
  realtype Temperature;    /* Temperature anchoring point for chemical databse, e.g. calculation of DH model */
  realtype Temperature_avg;  /* Temperature of the moment */
